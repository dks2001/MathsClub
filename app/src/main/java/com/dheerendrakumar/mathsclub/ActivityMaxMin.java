...
public class ActivityMaxMin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundId = soundPool.load(ActivityMaxMin.this, R.raw.click, 1);
            ...
            public void onFinish() {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        StoreScore ss = new StoreScore(numberOfQuestions,score,Integer.parseInt(t),"Maximum or minimum","gameZone");
                        ss.storescore();
