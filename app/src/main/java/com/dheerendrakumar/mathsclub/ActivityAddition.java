...
public class ActivityAddition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundId = soundPool.load(ActivityAddition.this, R.raw.click, 1);
            ...
            public void onClick(View v) {
                if(!timeEdt.getText().toString().equals("")) {
                    ...
                    if(Integer.parseInt(timeEdt.getText().toString()) > 200) {
                        Toast.makeText(ActivityAddition.this, "Maximum time 3 minutes", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    public void run() {
                        ...
                        finish.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                popupWindow.dismiss();
                                finish();
                                Intent intent = new Intent(ActivityAddition.this,WarmUp.class);
